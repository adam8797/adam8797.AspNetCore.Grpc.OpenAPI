...
internal sealed class GrpcJsonTranscodingDescriptionProvider : IApiDescriptionProvider
{
    ...
    private static ApiDescription CreateApiDescription(RouteEndpoint routeEndpoint, HttpRule httpRule, MethodDescriptor methodDescriptor, string pattern, string verb)
    {
        ...
        // Type must be set alongside ModelMetadata: Microsoft.AspNetCore.OpenApi reads the
        // CLR type straight off the description, whereas Swashbuckle read it from ModelMetadata.
        ...
        apiDescription.SupportedResponseTypes.Add(new ApiResponseType
        {
            ...
            // Unlike a numeric status code, "default" has no well-known reason phrase
            // for the OpenAPI generator to fall back to.
            Description = "Error"
        });
