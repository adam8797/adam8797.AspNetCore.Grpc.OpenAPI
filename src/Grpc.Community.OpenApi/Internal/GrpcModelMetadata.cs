...
internal sealed class GrpcModelMetadata : ModelMetadata
{
    ...
    /// <summary>
    /// The identity this metadata was created from. <see cref="ModelMetadata.Identity"/> is
    /// protected, so this exposes the underlying <see cref="PropertyInfo"/> /
    /// <see cref="ParameterInfo"/> that XML documentation lookups need.
    /// </summary>
    public ModelMetadataIdentity ModelIdentity => Identity;
