...
public class ResponseBodyTests
{
    ...
    [Fact]
    public async Task ResponseBodyString()
    {
        // Arrange & Act
        var swagger = await OpenApiTestHelpers.GetOpenApiDocumentAsync<ResponseBodyService>(_testOutputHelper);
    ...
    [Fact]
    public async Task ResponseBodyRepeatedString()
    {
        // Arrange & Act
        var swagger = await OpenApiTestHelpers.GetOpenApiDocumentAsync<ResponseBodyService>(_testOutputHelper);
    ...
    [Fact]
    public async Task ResponseBodyEnum()
    {
        // Arrange & Act
        var swagger = await OpenApiTestHelpers.GetOpenApiDocumentAsync<ResponseBodyService>(_testOutputHelper);
    ...
    [Fact]
    public async Task ResponseBodyMessage()
    {
        // Arrange & Act
        var swagger = await OpenApiTestHelpers.GetOpenApiDocumentAsync<ResponseBodyService>(_testOutputHelper);
